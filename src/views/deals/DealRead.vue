<template>
  <div class="app-container deal-read">
    <div class="read-header">
      ...
      <div class="read-actions">
        <router-link
          :to="{ name: 'editDeals', params: { id: deal.id } }"
          tag="button"
        ...
        <el-button @click="$router.push({ name: 'Deals' })">Назад</el-button>
      </div>
    </div>
  ...
  methods: {
    async fetchData() {
      ...
      try {
        ...
        handleApiError(this, err, 'Не удалось получить сделку')
      }
